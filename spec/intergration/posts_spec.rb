...
RSpec.describe 'Posts', type: :feature do
  before(:context) do
    @user = User.create(name: 'George R Martin',
                        photo: 'https://media.vanityfair.com/photos/62fa8f172d8966f073e581bb/master/w_2560%2Cc_limit/george-r-r-martin-portrait-redux.jpg', bio: 'Writter', posts_counter: 0)
    @user2 = User.create(name: 'Lee harmer',
                         photo: 'https://www.hollywoodreporter.com/wp-content/uploads/2013/10/harper_lee.jpg', bio: 'American novelist', posts_counter: 0)
